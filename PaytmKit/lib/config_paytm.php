...
if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	//Change this constant's value with Merchant key received from Paytm.
	$PAYTM_MERCHANT_MID 		= "QtnGQY85906213938938";
	$PAYTM_MERCHANT_KEY 		= "RfLn2tlQGxAHue1N";

	$PAYTM_CHANNEL_ID 		= "WEB";
	$PAYTM_INDUSTRY_TYPE_ID = "Retail";
	$PAYTM_MERCHANT_WEBSITE = "WEBSTAGING";

	$PAYTM_CALLBACK_URL 	= "https://192.168.43.79/four-square-constructions/PaytmKit/pgResponse.php";
