...
if (isset($_REQUEST['passwordUpdateBtn'])) {
  if (($_REQUEST['inputnewpassword'] == "")) {
    ...
    $sql = "SELECT * FROM seller WHERE se_email ='$sellerEmail'";
    // echo $sql;
    $result = $conn->query($sql);
    if ($result->num_rows == 1) {
      $se_password = $_REQUEST['inputnewpassword'];
      $sql = "UPDATE seller SET se_password='$se_password' WHERE se_email='$sellerEmail'";
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            ...
            <lable for="se_email">Email</lable>
            <input type="email" class="form-control" id="se_email" name ="se_email" value="<?php echo $_SESSION['sellerEmail']; ?>" readonly>
          </div>
